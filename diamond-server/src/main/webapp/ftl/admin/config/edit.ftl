...
<body>
<#assign updateConfigUrl="/admin.do?method=updateConfig">
...
<form action="${updateConfigUrl}" method="post" id="update-form">
    <table align='center'>
        ...
        <tr>
         ...
         <tr>  
            <td colspan="2">
               <textarea cols="100" rows="20" name="content" class="required max-length-65535">${configInfo.content}</textarea>
            </td>
        </tr>
        <tr> 
 ...
 <!-- 上传表单 -->
 <#assign reuploadUrl="/admin.do?method=reupload">
